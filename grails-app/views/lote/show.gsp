            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="lote.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="lote.itens.label" default="Itens" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${loteInstance.itens}" var="i">
